...
The App is a mobile application that allows users to combine multiple photos into a single image using selected layouts.

### Key Features
- Photo layout selection and merging
- Crop adjustment (pinch zoom, drag)
...
- Only information voluntarily entered by the user through the inquiry feature is transmitted to the server.

## 2. Eligibility

The App is intended for users aged 14 or older (under Korean Personal Information Protection Act) or 13 or older (under US COPPA). Users under these ages require parental or guardian consent.
...
1. Attempt to decompile, reverse-engineer, or extract the source code of the App
2. Create or distribute illegal content using the App
3. Interfere with the normal operation of the App
4. Send spam or false information through the inquiry feature
5. Infringe upon third-party rights (copyright, portrait rights, etc.) using the App

## 5. Advertising

- The App displays advertisements through Google AdMob.
- Watching rewarded ads unlocks certain premium features for 24 hours.
- For details on ad-related data collection, please refer to our [Privacy Policy](/hancute-legal/privacy/en).

## 6. Service Limitations and Changes

### Free Tier Limitations
- Maximum export resolution for free users is 2048px (longest side).
